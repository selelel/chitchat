...
export const SingUpUserInfoForm = () => {
    ...
    const {
        ...
        handleSubmit,
        formState: { errors },
    } = useForm<user_info_type>({ resolver: yupResolver(user_info_schema) })
    ...
    return (
        <Form submit={handleSubmit(handleCreatingUser)} className="space-y-2">
            ...
            <div className="flex flex-col w-full">
                ...
                <Form.Input register={register} name="firstname" />
            </div>
            ...
            <div className="flex flex-col w-full">
                ...
                <Form.Input register={register} name="lastname" />
            </div>
            ...
            <div className="flex flex-col w-full">
                ...
                <Form.Input register={register} name="username" />
            </div>
            ...
            <div className="flex w-full items-center">
                ...
                <Form.Checkbox register={register} name="hide_name" />
            </div>
