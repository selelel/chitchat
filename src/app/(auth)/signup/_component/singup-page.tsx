'use client'
import { SignUpUserCredentialForm } from '@/app/(auth)/signup/_component/signup-user-credential-form'
...
import { SingUpUserInfoForm } from '@/app/(auth)/signup/_component/signup-user-info-form'
...
export default function SignUpPage() {
    const [userInfoValues, setUserDataValues] =
        useState<user_credential_type | null>(null)

    const setUserValues = (data: user_credential_type) =>
            ...
            <div className="flex h-screen items-center col-span-1 w-full lg:w-7/12 sm:col-span-2 lg:col-span-7 p-5">
                <div className="space-y-5 w-full">
                    ...
                    <UserSignUpContext.Provider
                        value={{ setUserValues, userInfoValues }}
                    >
                        {!userInfoValues ? (
                            <SignUpUserCredentialForm />
                        ) : (
                            <SingUpUserInfoForm />
                        )}
                    </UserSignUpContext.Provider>
